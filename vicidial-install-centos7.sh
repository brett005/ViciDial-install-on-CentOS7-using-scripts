...
wget -O /etc/php.ini https://raw.githubusercontent.com/liveafzal/ViciDial-install-on-CentOS7-using-scripts/main/php.ini
...
wget -O /etc/httpd/conf/httpd.conf https://raw.githubusercontent.com/liveafzal/ViciDial-install-on-CentOS7-using-scripts/main/httpd.conf
...
wget -O /etc/astguiclient.conf https://raw.githubusercontent.com/liveafzal/ViciDial-install-on-CentOS7-using-scripts/main/astguiclient.conf
...
#Install Crontab
wget -O /root/crontab-file https://raw.githubusercontent.com/liveafzal/ViciDial-install-on-CentOS7-using-scripts/main/crontab
crontab /root/crontab-file
crontab -l

#Vicidial index.html Prepare
echo "" > /var/www/html/index.html
cat <<WEBROOTCONF>> /var/www/html/index.html
...
#Install rc.local
> /etc/rc.d/rc.local
wget -O /etc/rc.d/rc.local https://raw.githubusercontent.com/liveafzal/ViciDial-install-on-CentOS7-using-scripts/main/rc.local
